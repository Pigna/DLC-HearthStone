...
public class Invite implements Comparable<Invite>{
    ...
    public int compareTo(Invite o) {
        if(!getSender().getName().equals(o.getSender().getName()))
            return -1;
        if(!getReciever().getName().equals(o.getReciever().getName()))
            return -1;
        if(getLocation().equals(o.getLocation()))
            return -1;
        if(!getLocationName().equals(o.getLocationName()))
            return -1;
        return 1;
    }
}
